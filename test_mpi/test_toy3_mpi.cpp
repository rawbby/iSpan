...
{
  // forward graph
  constexpr auto fn_fw_adjacent = "toy3_fw_adjacent.bin";
  constexpr auto fn_fw_begin = "toy3_fw_begin.bin";
  constexpr auto fn_fw_head = "toy3_fw_head.bin";
  constexpr auto fn_out_degree = "toy3_out_degree.bin";
  ...
  // backward graph
  constexpr auto fn_bw_adjacent = "toy3_bw_adjacent.bin";
  constexpr auto fn_bw_begin = "toy3_bw_begin.bin";
  constexpr auto fn_bw_head = "toy3_bw_head.bin";
  constexpr auto fn_in_degree = "toy3_in_degree.bin";
